  ...
  return (
    <>
      <section className="h-screen flex flex-col md:flex-row items-center justify-center pt-16 overflow-hidden">
        ...
        >
          <h1
            className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold text-white leading-tight"
          ...
          <p
            className="mt-4 text-sm sm:text-base md:text-lg text-gray-300 max-w-lg mx-auto md:mx-0"
        ...
        <div
          className="w-full md:w-1/2 h-64 sm:h-80 md:h-1/2 lg:h-full"
          data-aos="fade-left"
        >
      ...
      <section id="gallery" className="py-20 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 flex justify-center">
            <div className="inline-grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
              {images.map((src, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500"></div>
                  </div>
