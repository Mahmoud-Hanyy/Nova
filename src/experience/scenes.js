...
export const scenes = [
  {
    ...
    light: { keyColor: "#F7F3EA", keyIntensity: 1.6, rimColor: "#C49AF2", rimIntensity: 0.8 },
    fov: 45,
  ...
  },
  {
    ...
    light: { keyColor: "#EADCF7", keyIntensity: 1.3, rimColor: "#B69ACF", rimIntensity: 0.75 },
    fov: 38,
    viewOffset: -0.22,
    eyebrow: "01 — Exterior",
  ...
  },
  {
    ...
    light: { keyColor: "#C49AF2", keyIntensity: 0.95, rimColor: "#F7F3EA", rimIntensity: 0.9 },
    fov: 42,
    viewOffset: -0.22,
  ...
  },
  {
    ...
    light: { keyColor: "#F7F3EA", keyIntensity: 1.2, rimColor: "#9B5DE5", rimIntensity: 0.6 },
    fov: 48,
    viewOffset: -0.2,
    eyebrow: "03 — Nova",
